...
public interface AutorSwegger {
    ...
    ResponseEntity<AutorDTO> criarAutor(@RequestBody AutorDTO autorDTO);
    ...
    @ApiResponse(responseCode = "404", description = "Autor não encontrado")
    ResponseEntity<?> atualizarAutor(@RequestBody AutorDTO autorDTO) ;
